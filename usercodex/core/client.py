...
class CodexClient(TelegramClient):
    def codex_cmd(
        self: TelegramClient,
        ...
        **kwargs,
        ...
        def decorator(func):  # sourcery no-metrics
            ...
            if pattern is not None:
                ...
                if edited:
                    codex.add_event_handler(func, events.MessageEdited(**kwargs))
                codex.add_event_handler(func, events.NewMessage(**kwargs))
            return wrapper
    ...
    def bot_cmd(
        ...
        **kwargs,
        ...
        def decorator(func):
            ...
            if edited is True:
                codex.tgbot.add_event_handler(func, events.MessageEdited(**kwargs))
            else:
                codex.tgbot.add_event_handler(func, events.NewMessage(**kwargs))
...
CodexClient.fast_download_file = download_file
CodexClient.fast_upload_file = upload_file
CodexClient.reload = restart_script
CodexClient.get_msg_link = get_message_link
CodexClient.check_testcases = checking
try:
