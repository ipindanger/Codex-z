...
@codex.cod_cmd(
    ...
    info={
        ...
        "examples": "{tr}downside codexuserbot",
    },
)
...
@codex.cod_cmd(
    ...
    info={
        ...
        "examples": "{tr}subscript codexuserbot",
    },
)
async def stylish_generator(event):
...
@codex.cod_cmd(
    ...
    info={
        ...
        "examples": "{tr}superscript codexuserbot",
    },
)
async def stylish_generator(event):
